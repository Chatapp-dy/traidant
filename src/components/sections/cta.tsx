        ...
        <div className="max-w-[1600px] mx-auto">
          {!showForm ? (
            ...
            >
              ...
              <p className="text-lg sm:text-xl lg:text-2xl xl:text-3xl text-gray-300 mb-16 max-w-5xl mx-auto leading-relaxed">
              ...
              {/* Enhanced Stats Grid */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 xl:gap-16 mb-16 max-w-6xl mx-auto">
                <motion.div 
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.6, delay: 0.2 }}
                  className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 lg:p-8 xl:p-10 border border-white/10 hover:bg-white/10 transition-all duration-300"
                >
                  <div className="flex items-center justify-center gap-3 mb-4">
                    <Shield className="w-8 h-8 text-green-400" />
                    <span className="text-2xl lg:text-3xl xl:text-4xl font-bold text-white">98.7%</span>
                  </div>
                  <div className="text-gray-300 font-medium text-lg lg:text-xl">AI Prediction Accuracy</div>
                ...
                >
                  <div className="flex items-center justify-center gap-3 mb-4">
                    ...
                    <span className="text-2xl lg:text-3xl xl:text-4xl font-bold text-white">$2.4B+</span>
                  </div>
                  <div className="text-gray-300 font-medium text-lg lg:text-xl">Assets Under Management</div>
                  <div className="text-sm text-gray-400 mt-2">Professional Grade Protection</div>
                </motion.div>
                ...
                >
                  <div className="flex items-center justify-center gap-3 mb-4">
                    ...
                    <span className="text-2xl lg:text-3xl xl:text-4xl font-bold text-white">15K+</span>
                  </div>
                  <div className="text-gray-300 font-medium text-lg lg:text-xl">Active Investors</div>
                  <div className="text-sm text-gray-400 mt-2">Trusted Community</div>
                </motion.div>
              </div>
