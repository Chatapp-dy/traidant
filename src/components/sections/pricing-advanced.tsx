      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-10">
        <div className="max-w-[1600px] mx-auto">
          ...
          <motion.div
            ...
            className="text-center mb-8 lg:mb-12 xl:mb-16"
          >
...
All plans include access to our platform and dedicated support."
          ...
          >
            <div className="grid sm:grid-cols-3 gap-6 lg:gap-8 xl:gap-12">
              <div className="space-y-2 lg:space-y-3 p-6 lg:p-8 xl:p-10 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 shadow-sm">
            ...
            <p className="text-gray-600 mt-8 lg:mt-10 xl:mt-12 text-lg lg:text-xl xl:text-2xl leading-relaxed max-w-4xl mx-auto">
