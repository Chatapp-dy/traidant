        ...
        <div className="max-w-7xl mx-auto">
                ...
                <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-gray-50 group-hover:from-gray-50 group-hover:to-white">
                  <CardContent className="p-6 lg:p-8 h-full flex flex-col">
                    <div className="space-y-4 flex-1">
                      {/* Icon */}
                      <div className={`w-12 h-12 lg:w-14 lg:h-14 rounded-xl bg-gradient-to-r ${feature.gradient} p-3 group-hover:scale-110 transition-transform duration-300`}>
                        <feature.icon className="w-full h-full text-white" />
                      </div>

                      {/* Content */}
                      <div className="space-y-3 flex-1">
                        <h3 className="text-xl lg:text-2xl font-bold text-gray-900 group-hover:text-gray-700 transition-colors">
                          {feature.title}
                        </h3>
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 text-blue-600 font-semibold hover:text-blue-700 transition-colors cursor-pointer text-base lg:text-lg"
            >
