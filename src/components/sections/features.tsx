...
export function FeaturesSection() {
  ...
  return (
    <section className="w-full py-16 sm:py-20 lg:py-24 xl:py-32 2xl:py-40 bg-white relative overflow-hidden">
      ...
      <div className="w-full px-6 sm:px-8 lg:px-12 xl:px-16 2xl:px-24 relative z-10">
        <div className="w-full">
          ...
          >
            ...
            <p className="text-lg sm:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-gray-600 leading-relaxed">
              Our cutting-edge AI technology gives you the competitive edge in today's fast-paced financial markets.
            </p>
          </motion.div>

          {/* Features Grid */}
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 xl:gap-12 2xl:gap-16">
              ...
              >
                <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-gray-50 group-hover:from-gray-50 group-hover:to-white">
                  <CardContent className="p-6 lg:p-8 xl:p-10 2xl:p-12 h-full flex flex-col">
                    <div className="space-y-4 lg:space-y-6 xl:space-y-8 flex-1">
                      {/* Icon */}
                      <div className={`w-12 h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 2xl:w-18 2xl:h-18 rounded-xl bg-gradient-to-r ${feature.gradient} p-3 group-hover:scale-110 transition-transform duration-300`}>
                        <feature.icon className="w-full h-full text-white" />
                      </div>

                      {/* Content */}
                      <div className="space-y-3 lg:space-y-4 xl:space-y-5 flex-1">
                        <h3 className="text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold text-gray-900 group-hover:text-gray-700 transition-colors">
                          {feature.title}
                        </h3>
                        <p className="text-gray-600 leading-relaxed text-sm lg:text-base xl:text-lg 2xl:text-xl">
                          {feature.description}
                        </p>
                      </div>
                    </div>
          ...
          >
            <p className="text-lg lg:text-xl xl:text-2xl 2xl:text-3xl text-gray-600 mb-6 lg:mb-8">
              Ready to experience the future of investing?
            </p>
            <button
              onClick={openAIFeatures}
              className="inline-flex items-center gap-2 text-blue-600 font-semibold hover:text-blue-700 transition-colors cursor-pointer text-base lg:text-lg xl:text-xl 2xl:text-2xl"
            >
